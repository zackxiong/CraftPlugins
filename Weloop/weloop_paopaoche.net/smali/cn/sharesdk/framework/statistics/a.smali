...
.field private static d:Lcn/sharesdk/framework/statistics/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/sharesdk/framework/statistics/a;->e:Ljava/lang/String;

    const-string v0, "http://s.sharesdk.cn/api/convert3.do"

    sput-object v0, Lcn/sharesdk/framework/statistics/a;->f:Ljava/lang/String;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcn/sharesdk/framework/statistics/a;->j:Lcn/sharesdk/framework/network/h;
...
.method public static a(Landroid/content/Context;)Lcn/sharesdk/framework/statistics/a;
    ...
    sget-object v0, Lcn/sharesdk/framework/statistics/a;->d:Lcn/sharesdk/framework/statistics/a;
    ...
    sput-object v0, Lcn/sharesdk/framework/statistics/a;->d:Lcn/sharesdk/framework/statistics/a;
...
.method private a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lcn/sharesdk/framework/statistics/a;->j:Lcn/sharesdk/framework/network/h;

    sget-object v1, Lcn/sharesdk/framework/statistics/a;->f:Ljava/lang/String;
...
.method private d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcn/sharesdk/framework/statistics/a/c;->a(Landroid/content/Context;)Lcn/sharesdk/framework/statistics/a/c;
    ...
    iget v4, p0, Lcn/sharesdk/framework/statistics/a;->i:I
    ...
    invoke-virtual {p0, v1, v0}, Lcn/sharesdk/framework/statistics/a;->a(Ljava/lang/String;[B)Ljava/lang/String;
...
.method public a()J
    ...
    :try_start_0
    iget-object v1, p0, Lcn/sharesdk/framework/statistics/a;->j:Lcn/sharesdk/framework/network/h;
...
.method public a(Ljava/lang/String;)J
    ...
    invoke-virtual {v7}, Lcn/sharesdk/framework/utils/b;->q()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lcn/sharesdk/framework/utils/b;->o()I
    ...
    invoke-virtual {v7}, Lcn/sharesdk/framework/utils/b;->r()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lcn/sharesdk/framework/utils/b;->t()I
    ...
    iget v0, p0, Lcn/sharesdk/framework/statistics/a;->i:I
    ...
    invoke-virtual {v7}, Lcn/sharesdk/framework/utils/b;->n()Ljava/lang/String;
    ...
    sget-object v1, Lcn/sharesdk/framework/statistics/a;->e:Ljava/lang/String;
    ...
    invoke-virtual {v6, v2, v3}, Lcn/sharesdk/framework/statistics/a/c;->a(Ljava/lang/String;Ljava/lang/Long;)V
    ...
    invoke-virtual {v6, v1}, Lcn/sharesdk/framework/statistics/a/c;->d(Ljava/lang/String;)V

    invoke-virtual {v6, v2}, Lcn/sharesdk/framework/statistics/a/c;->f(Ljava/lang/String;)V

    invoke-virtual {v6, v0}, Lcn/sharesdk/framework/statistics/a/c;->e(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v1}, Lcn/sharesdk/framework/utils/b;->a(Z)Ljava/util/ArrayList;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lcn/sharesdk/framework/statistics/a;->a(Ljava/lang/String;Ljava/util/ArrayList;)V
    :try_end_2
    ...
    :try_start_3
    invoke-direct {p0}, Lcn/sharesdk/framework/statistics/a;->h()Ljava/lang/String;
...
.method public a(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcn/sharesdk/framework/statistics/a;->b(Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public a(Lcn/sharesdk/framework/statistics/b/c;)V
    ...
    invoke-static {v2}, Lcn/sharesdk/framework/statistics/a/c;->a(Landroid/content/Context;)Lcn/sharesdk/framework/statistics/a/c;
    ...
    :cond_0
    :goto_0
    invoke-virtual {v5}, Lcn/sharesdk/framework/statistics/a/c;->b()Z

    move-result v0

    if-nez v0, :cond_1

    iput-object v9, p1, Lcn/sharesdk/framework/statistics/b/c;->m:Ljava/lang/String;

    :cond_1
    invoke-virtual {v5}, Lcn/sharesdk/framework/statistics/a/c;->a()J
    ...
    invoke-virtual {p0}, Lcn/sharesdk/framework/statistics/a;->a()J
    ...
    invoke-virtual {v5}, Lcn/sharesdk/framework/statistics/a/c;->c()Z
    ...
    iput-object v9, v0, Lcn/sharesdk/framework/statistics/b/b;->d:Ljava/lang/String;

    move-object v0, p1

    check-cast v0, Lcn/sharesdk/framework/statistics/b/b;

    iput-object v9, v0, Lcn/sharesdk/framework/statistics/b/b;->c:Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcn/sharesdk/framework/statistics/a/c;->d()I
    ...
    iget-object v7, v0, Lcn/sharesdk/framework/statistics/b/f;->d:Lcn/sharesdk/framework/statistics/b/f$a;

    if-eq v1, v8, :cond_6

    if-nez v1, :cond_e

    iget-boolean v1, p0, Lcn/sharesdk/framework/statistics/a;->h:Z
    ...
    iget-object v1, v7, Lcn/sharesdk/framework/statistics/b/f$a;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1}, Lcn/sharesdk/framework/statistics/a;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_8

    iget-object v8, v7, Lcn/sharesdk/framework/statistics/b/f$a;->d:Ljava/util/ArrayList;
    ...
    iget-object v1, v7, Lcn/sharesdk/framework/statistics/b/f$a;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1}, Lcn/sharesdk/framework/statistics/a;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_c

    iget-object v4, v7, Lcn/sharesdk/framework/statistics/b/f$a;->d:Ljava/util/ArrayList;
    ...
    :cond_e
    iput-object v9, v0, Lcn/sharesdk/framework/statistics/b/f;->d:Lcn/sharesdk/framework/statistics/b/f$a;

    :cond_f
    if-nez v6, :cond_0

    iput-object v9, v0, Lcn/sharesdk/framework/statistics/b/f;->n:Ljava/lang/String;
...
.method public a(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    const-string v5, "sdk.sharesdk.sdk"

    invoke-static {v0, v5}, Lcn/sharesdk/framework/utils/a;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public a(Z)V
    ...
    iput-boolean p1, p0, Lcn/sharesdk/framework/statistics/a;->h:Z
...
.method public b()V
    ...
    invoke-virtual {p0, v2}, Lcn/sharesdk/framework/statistics/a;->c(Ljava/lang/String;)Ljava/lang/String;
