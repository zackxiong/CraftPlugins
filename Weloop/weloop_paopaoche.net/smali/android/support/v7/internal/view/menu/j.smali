...
# virtual methods
.method a(Landroid/view/ActionProvider;)Landroid/support/v7/internal/view/menu/j$a;
    .locals 2
...
.method public a(Z)V
    ...
    .line 298
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/j;->c:Ljava/lang/reflect/Method;

    if-nez v0, :cond_0

    .line 299
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/j;->b:Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/j;->c:Ljava/lang/reflect/Method;

    .line 302
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/j;->c:Ljava/lang/reflect/Method;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/j;->b:Ljava/lang/Object;
...
.method public getActionProvider()Landroid/view/ActionProvider;
    ...
    invoke-interface {v0}, Landroid/support/v4/c/a/b;->a()Landroid/support/v4/view/h;

    move-result-object v0

    .line 268
    instance-of v1, v0, Landroid/support/v7/internal/view/menu/j$a;

    if-eqz v1, :cond_0

    .line 269
    check-cast v0, Landroid/support/v7/internal/view/menu/j$a;

    iget-object v0, v0, Landroid/support/v7/internal/view/menu/j$a;->a:Landroid/view/ActionProvider;
...
.method public getActionView()Landroid/view/View;
    ...
    .line 252
    instance-of v1, v0, Landroid/support/v7/internal/view/menu/j$b;

    if-eqz v1, :cond_0

    .line 253
    check-cast v0, Landroid/support/v7/internal/view/menu/j$b;

    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/j$b;->c()Landroid/view/View;
...
.method public getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/internal/view/menu/j;->a(Landroid/view/SubMenu;)Landroid/view/SubMenu;
...
.method public setActionProvider(Landroid/view/ActionProvider;)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/internal/view/menu/j;->a(Landroid/view/ActionProvider;)Landroid/support/v7/internal/view/menu/j$a;

    move-result-object v1

    :goto_0
    invoke-interface {v0, v1}, Landroid/support/v4/c/a/b;->a(Landroid/support/v4/view/h;)Landroid/support/v4/c/a/b;
...
.method public setActionView(I)Landroid/view/MenuItem;
    ...
    new-instance v2, Landroid/support/v7/internal/view/menu/j$b;

    invoke-direct {v2, v1}, Landroid/support/v7/internal/view/menu/j$b;-><init>(Landroid/view/View;)V
...
.method public setActionView(Landroid/view/View;)Landroid/view/MenuItem;
    ...
    .line 230
    new-instance v0, Landroid/support/v7/internal/view/menu/j$b;

    invoke-direct {v0, p1}, Landroid/support/v7/internal/view/menu/j$b;-><init>(Landroid/view/View;)V
...
.method public setOnActionExpandListener(Landroid/view/MenuItem$OnActionExpandListener;)Landroid/view/MenuItem;
    ...
    new-instance v1, Landroid/support/v7/internal/view/menu/j$c;

    invoke-direct {v1, p0, p1}, Landroid/support/v7/internal/view/menu/j$c;-><init>(Landroid/support/v7/internal/view/menu/j;Landroid/view/MenuItem$OnActionExpandListener;)V

    :goto_0
    invoke-interface {v0, v1}, Landroid/support/v4/c/a/b;->a(Landroid/support/v4/view/u$e;)Landroid/support/v4/c/a/b;
...
.method public setOnMenuItemClickListener(Landroid/view/MenuItem$OnMenuItemClickListener;)Landroid/view/MenuItem;
    ...
    new-instance v1, Landroid/support/v7/internal/view/menu/j$d;

    invoke-direct {v1, p0, p1}, Landroid/support/v7/internal/view/menu/j$d;-><init>(Landroid/support/v7/internal/view/menu/j;Landroid/view/MenuItem$OnMenuItemClickListener;)V
