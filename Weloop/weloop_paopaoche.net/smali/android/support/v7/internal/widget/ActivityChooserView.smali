...
# instance fields
.field a:Landroid/support/v4/view/h;
...
.method private a(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ActivityChooserView$a;->d()Landroid/support/v7/internal/widget/i;
    ...
    .line 368
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/n;
    ...
    .line 376
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/n;->d(I)V

    .line 377
    invoke-virtual {v3}, Landroid/support/v7/widget/n;->c()V

    .line 378
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/view/h;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/h;->a(Z)V

    .line 381
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/n;->g()Landroid/widget/ListView;
...
.method private getListPopupWindow()Landroid/support/v7/widget/n;
    .locals 2

    .prologue
    .line 505
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/n;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/n;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/n;->a(Landroid/widget/ListAdapter;)V

    .line 508
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/n;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/n;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/n;->a(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/n;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/n;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 454
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->d:Landroid/support/v7/widget/m;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/m;->layout(IIII)V
...
.method public setActivityChooserModel(Landroid/support/v7/internal/widget/i;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/ActivityChooserView$a;->a(Landroid/support/v7/internal/widget/i;)V
...
.method public setProvider(Landroid/support/v4/view/h;)V
    ...
    .prologue
    .line 325
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/view/h;
