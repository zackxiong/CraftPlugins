...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 70
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/ac;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/j;->setIndeterminateDrawable(Landroid/graphics/drawable/Drawable;)V

    .line 75
    :cond_0
    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/ac;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 77
    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/j;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 89
    instance-of v0, p1, Landroid/support/v4/b/a/g;
    ...
    .line 90
    check-cast v0, Landroid/support/v4/b/a/g;

    invoke-interface {v0}, Landroid/support/v4/b/a/g;->a()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/b/a/g;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 115
    iget-object v1, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/Bitmap;

    if-nez v1, :cond_7

    .line 116
    iput-object v0, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/Bitmap;

    .line 119
    :cond_7
    new-instance v1, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {p0}, Landroid/support/v7/widget/j;->getDrawableShape()Landroid/graphics/drawable/shapes/Shape;
...
.method protected declared-synchronized onMeasure(II)V
    ...
    .line 162
    iget-object v0, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/j;->getNumStars()I
    ...
    invoke-static {v0, p1, v1}, Landroid/support/v4/view/ak;->a(III)I

    move-result v0

    invoke-virtual {p0}, Landroid/support/v7/widget/j;->getMeasuredHeight()I

    move-result v1

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/j;->setMeasuredDimension(II)V
    :try_end_0
