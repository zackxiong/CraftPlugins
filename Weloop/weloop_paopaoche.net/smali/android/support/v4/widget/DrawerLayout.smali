...
# static fields
.field static final a:Landroid/support/v4/widget/DrawerLayout$b;
...
.field private final d:Landroid/support/v4/widget/DrawerLayout$a;
...
.field private final i:Landroid/support/v4/widget/r;

.field private final j:Landroid/support/v4/widget/r;

.field private final k:Landroid/support/v4/widget/DrawerLayout$g;

.field private final l:Landroid/support/v4/widget/DrawerLayout$g;
...
.field private t:Landroid/support/v4/widget/DrawerLayout$e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$b;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/ak;->c(Landroid/view/View;I)V
...
.method private d()Z
    ...
    .line 1437
    iget-boolean v0, v0, Landroid/support/v4/widget/DrawerLayout$f;->c:Z
...
.method a()Landroid/view/View;
    ...
    iget-boolean v0, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:Z
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/r;

    .line 483
    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/r;->e()V
...
.method a(IILandroid/view/View;)V
    ...
    .line 611
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/r;

    invoke-virtual {v2}, Landroid/support/v4/widget/r;->a()I

    move-result v2

    .line 612
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/r;

    invoke-virtual {v3}, Landroid/support/v4/widget/r;->a()I
    ...
    .line 625
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$f;->b:F
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/widget/DrawerLayout$e;->a(I)V
    ...
    .line 627
    :cond_6
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$f;->b:F
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/widget/DrawerLayout$e;->a(Landroid/view/View;F)V
...
.method a(Z)V
    ...
    iget-boolean v6, v0, Landroid/support/v4/widget/DrawerLayout$f;->c:Z
    ...
    .line 1268
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/r;
    ...
    .line 1275
    :goto_2
    iput-boolean v3, v0, Landroid/support/v4/widget/DrawerLayout$f;->c:Z

    goto :goto_1

    .line 1271
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/r;
    ...
    .line 1278
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/DrawerLayout$g;

    invoke-virtual {v0}, Landroid/support/v4/widget/DrawerLayout$g;->a()V

    .line 1279
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/DrawerLayout$g;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 1571
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/DrawerLayout$a;
...
.method b(Landroid/view/View;)V
    ...
    .line 643
    iget-boolean v1, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:Z

    if-eqz v1, :cond_1

    .line 644
    iput-boolean v2, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/DrawerLayout$e;->b(Landroid/view/View;)V
...
.method b(Landroid/view/View;F)V
    ...
    .line 707
    iget v1, v0, Landroid/support/v4/widget/DrawerLayout$f;->b:F
    ...
    .line 711
    :cond_0
    iput p2, v0, Landroid/support/v4/widget/DrawerLayout$f;->b:F
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/DrawerLayout$e;->a(Landroid/view/View;)V
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/r;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/r;->b()I
...
.method e(Landroid/view/View;)I
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$f;->a:I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v4/widget/DrawerLayout$f;-><init>(II)V
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/widget/DrawerLayout$f;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/DrawerLayout$f;-><init>(Landroid/support/v4/widget/DrawerLayout$f;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/DrawerLayout$f;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/DrawerLayout$f;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public h(Landroid/view/View;)V
    ...
    iput v1, v0, Landroid/support/v4/widget/DrawerLayout$f;->b:F
...
.method public i(Landroid/view/View;)V
    ...
    iput-boolean v1, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1054
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$b;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->z:Ljava/lang/Object;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/DrawerLayout$b;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1140
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/r;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/r;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/r;
    ...
    .line 1152
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/r;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/r;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/r;->d(I)Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 907
    iget v1, v0, Landroid/support/v4/widget/DrawerLayout$f;->leftMargin:I

    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$f;->topMargin:I

    iget v3, v0, Landroid/support/v4/widget/DrawerLayout$f;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$f;->topMargin:I
    ...
    iget v3, v0, Landroid/support/v4/widget/DrawerLayout$f;->b:F
    ...
    .line 926
    :goto_3
    iget v4, v0, Landroid/support/v4/widget/DrawerLayout$f;->a:I
    ...
    .line 931
    iget v4, v0, Landroid/support/v4/widget/DrawerLayout$f;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Landroid/support/v4/widget/DrawerLayout$f;->topMargin:I
    ...
    .line 938
    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$f;->bottomMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/DrawerLayout$f;->bottomMargin:I
    ...
    .line 951
    iget v12, v0, Landroid/support/v4/widget/DrawerLayout$f;->topMargin:I
    ...
    iget v13, v0, Landroid/support/v4/widget/DrawerLayout$f;->bottomMargin:I
    ...
    .line 954
    iget v4, v0, Landroid/support/v4/widget/DrawerLayout$f;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/ak;->m(Landroid/view/View;)Z
    ...
    .line 854
    iget v9, v0, Landroid/support/v4/widget/DrawerLayout$f;->a:I
    ...
    .line 855
    invoke-static {v8}, Landroid/support/v4/view/ak;->m(Landroid/view/View;)Z
    ...
    .line 856
    sget-object v10, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$b;

    iget-object v11, p0, Landroid/support/v4/widget/DrawerLayout;->z:Ljava/lang/Object;

    invoke-interface {v10, v8, v11, v9}, Landroid/support/v4/widget/DrawerLayout$b;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 864
    iget v9, v0, Landroid/support/v4/widget/DrawerLayout$f;->leftMargin:I

    sub-int v9, v2, v9

    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$f;->rightMargin:I
    ...
    .line 866
    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$f;->topMargin:I

    sub-int v10, v1, v10

    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$f;->bottomMargin:I
    ...
    invoke-interface {v10, v0, v11, v9}, Landroid/support/v4/widget/DrawerLayout$b;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$f;->leftMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$f;->width:I
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$f;->height:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1205
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/r;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/r;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/r;->d()I
...
.method public setDrawerListener(Landroid/support/v4/widget/DrawerLayout$e;)V
    .locals 0

    .prologue
    .line 432
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/DrawerLayout$e;
