...
.field l:Landroid/support/v4/f/i;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/k;->b:Landroid/support/v4/app/p;
    ...
    iput-object v0, p0, Landroid/support/v4/app/k;->c:Landroid/support/v4/app/n;
...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/ac;
    ...
    .prologue
    .line 866
    iget-object v0, p0, Landroid/support/v4/app/k;->l:Landroid/support/v4/f/i;
    ...
    iput-object v0, p0, Landroid/support/v4/app/k;->l:Landroid/support/v4/f/i;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/app/ac;-><init>(Ljava/lang/String;Landroid/support/v4/app/k;Z)V

    .line 873
    iget-object v1, p0, Landroid/support/v4/app/k;->l:Landroid/support/v4/f/i;
    ...
    .line 876
    :cond_2
    invoke-virtual {v0, p0}, Landroid/support/v4/app/ac;->a(Landroid/support/v4/app/k;)V
...
.method a(Z)V
    ...
    .line 765
    iput-boolean p1, p0, Landroid/support/v4/app/k;->h:Z
...
.method protected b()V
    ...
    .prologue
    .line 447
    iget-object v0, p0, Landroid/support/v4/app/k;->b:Landroid/support/v4/app/p;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 658
    iget-boolean v1, p0, Landroid/support/v4/app/k;->d:Z
    ...
    .line 664
    iget-object v0, p0, Landroid/support/v4/app/k;->m:Landroid/support/v4/app/ac;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 155
    iget-object v1, p0, Landroid/support/v4/app/k;->b:Landroid/support/v4/app/p;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/k;->c:Landroid/support/v4/app/n;

    invoke-virtual {v0, p0, v2, v1}, Landroid/support/v4/app/p;->a(Landroid/support/v4/app/k;Landroid/support/v4/app/n;Landroid/support/v4/app/Fragment;)V
    ...
    .line 262
    iget-object v2, v0, Landroid/support/v4/app/k$a;->e:Landroid/support/v4/f/i;

    iput-object v2, p0, Landroid/support/v4/app/k;->l:Landroid/support/v4/f/i;
    ...
    .line 266
    iget-object v3, p0, Landroid/support/v4/app/k;->b:Landroid/support/v4/app/p;

    if-eqz v0, :cond_3

    iget-object v0, v0, Landroid/support/v4/app/k$a;->d:Ljava/util/ArrayList;
...
.method public onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {v0, v1, p1, p2, p3}, Landroid/support/v4/app/p;->a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    .line 483
    invoke-virtual {p0, v1}, Landroid/support/v4/app/k;->a(Z)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/f/i;->c(I)Ljava/lang/Object;
    ...
    .line 504
    iget-object v9, p0, Landroid/support/v4/app/k;->l:Landroid/support/v4/f/i;

    iget-object v4, v4, Landroid/support/v4/app/ac;->d:Ljava/lang/String;

    invoke-virtual {v9, v4}, Landroid/support/v4/f/i;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 513
    iput-object v2, v0, Landroid/support/v4/app/k$a;->a:Ljava/lang/Object;

    .line 514
    iput-object v5, v0, Landroid/support/v4/app/k$a;->b:Ljava/lang/Object;

    .line 515
    iput-object v2, v0, Landroid/support/v4/app/k$a;->c:Landroid/support/v4/f/i;

    .line 516
    iput-object v6, v0, Landroid/support/v4/app/k$a;->d:Ljava/util/ArrayList;

    .line 517
    iget-object v1, p0, Landroid/support/v4/app/k;->l:Landroid/support/v4/f/i;

    iput-object v1, v0, Landroid/support/v4/app/k$a;->e:Landroid/support/v4/f/i;
...
.method protected onStart()V
    ...
    .line 546
    iput-boolean v3, p0, Landroid/support/v4/app/k;->d:Z
    ...
    iget-boolean v2, p0, Landroid/support/v4/app/k;->k:Z

    invoke-virtual {p0, v0, v2, v1}, Landroid/support/v4/app/k;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/ac;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/k;->m:Landroid/support/v4/app/ac;
