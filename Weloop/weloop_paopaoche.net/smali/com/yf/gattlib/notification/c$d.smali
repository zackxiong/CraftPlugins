.class Lcom/yf/gattlib/notification/c$d;
...
.method private constructor <init>(Lcom/yf/gattlib/notification/c;)V
    ...
    .prologue
    .line 182
    iput-object p1, p0, Lcom/yf/gattlib/notification/c$d;->a:Lcom/yf/gattlib/notification/c;
...
.method synthetic constructor <init>(Lcom/yf/gattlib/notification/c;Lcom/yf/gattlib/notification/c$1;)V
    ...
    .prologue
    .line 182
    invoke-direct {p0, p1}, Lcom/yf/gattlib/notification/c$d;-><init>(Lcom/yf/gattlib/notification/c;)V
...
.method public a(Landroid/widget/RemoteViews;Lcom/yf/gattlib/notification/NotificationContent;)V
    ...
    .line 188
    new-instance v2, Landroid/widget/YFRemoteViews2;

    invoke-direct {v2, v0}, Landroid/widget/YFRemoteViews2;-><init>(Landroid/os/Parcel;)V

    .line 190
    const-string v1, ""

    .line 191
    iget-object v0, v2, Landroid/widget/YFRemoteViews2;->c:Ljava/util/ArrayList;
    ...
    .line 192
    instance-of v3, v0, Landroid/widget/YFRemoteViews2$ReflectionAction;

    if-eqz v3, :cond_0

    .line 196
    check-cast v0, Landroid/widget/YFRemoteViews2$ReflectionAction;

    .line 197
    const-string v3, "setText"

    iget-object v4, v0, Landroid/widget/YFRemoteViews2$ReflectionAction;->b:Ljava/lang/String;
    ...
    .line 198
    :cond_1
    iget-object v3, v0, Landroid/widget/YFRemoteViews2$ReflectionAction;->d:Ljava/lang/Object;

    if-eqz v3, :cond_0

    .line 202
    iget-object v0, v0, Landroid/widget/YFRemoteViews2$ReflectionAction;->d:Ljava/lang/Object;
