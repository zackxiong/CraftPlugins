    ...
    public static class Req extends BaseReq {
        ...
        public boolean checkArgs() {
            if (this.toUserName == null || this.toUserName.length() == 0) {
                C0723a.m7143a(TAG, "checkArgs fail, toUserName is invalid");
                return false;
            } else if (this.extMsg != null && this.extMsg.length() > EXT_MSG_LENGTH) {
                C0723a.m7143a(TAG, "ext msg is not null, while the length exceed 1024 bytes");
                return false;
            } else if (this.profileType != JumpToBizProfile.JUMP_TO_HARD_WARE_BIZ_PROFILE || (this.extMsg != null && this.extMsg.length() != 0)) {
                return true;
            } else {
                C0723a.m7143a(TAG, "scene is jump to hardware profile, while extmsg is null");
                return false;
            }
        }
