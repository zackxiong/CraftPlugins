...
public final class TypeAdapters {
    ...
    final class ProGuard extends TypeAdapter<Class> {
        ProGuard() {
        }
    ...
    final class ProGuard extends TypeAdapter<BitSet> {
        ProGuard() {
        }
    ...
    final class ProGuard extends TypeAdapter<Boolean> {
        ProGuard() {
        }
    ...
    final class ProGuard extends TypeAdapter<Number> {
        ProGuard() {
        }
    ...
    static {
        ...
        BIT_SET = new ProGuard();
        BIT_SET_FACTORY = newFactory(BitSet.class, BIT_SET);
        BOOLEAN = new ProGuard();
        BOOLEAN_AS_STRING = new ProGuard();
        BOOLEAN_FACTORY = newFactory(Boolean.TYPE, Boolean.class, BOOLEAN);
        BYTE = new ProGuard();
        BYTE_FACTORY = newFactory(Byte.TYPE, Byte.class, BYTE);
        SHORT = new ProGuard();
        SHORT_FACTORY = newFactory(Short.TYPE, Short.class, SHORT);
        INTEGER = new ProGuard();
        ...
        TIMESTAMP_FACTORY = new TypeAdapterFactory() {
            ...
            class ProGuard extends TypeAdapter<Timestamp> {
                final /* synthetic */ TypeAdapter val$dateTypeAdapter;

                ProGuard(TypeAdapter typeAdapter) {
            ...
            public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
                ...
                return new ProGuard(gson.getAdapter(Date.class));
            }
        };
