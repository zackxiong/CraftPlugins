...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    final class ProGuard implements Comparator<Comparable> {
        ProGuard() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class ProGuard extends LinkedTreeMapIterator<Entry<K, V>> {
            ProGuard() {
                super(null);
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class ProGuard extends LinkedTreeMapIterator<K> {
            ProGuard() {
                super(null);
            }
