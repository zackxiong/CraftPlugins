...
public class BitmapHelper {
    private static Bitmap m3200a(Bitmap bitmap, int i, boolean z) {
        Bitmap bitmap2;
        if (z) {
            bitmap2 = bitmap;
        } else {
        ...
        i7 = (i8 + 1) >> 1;
        int i9 = i7 * i7;
        int[] iArr6 = new int[(i9 * ProGuard.f5669b)];
        for (i7 = 0; i7 < i9 * ProGuard.f5669b; i7++) {
            iArr6[i7] = i7 / i9;
        }
    ...
    private static Bitmap m3201a(InputStream inputStream, int i) {
    ...
    public static String downloadBitmap(Context context, String str) {
        return new C0037h().m3013a(context, str, "images", true);
    }
    ...
    public static Bitmap getBitmap(File file, int i) {
        ...
        Bitmap a = m3201a(fileInputStream, i);
    ...
    public static String saveViewToImage(View view, int i, int i2) {
        ...
        File file = new File(C0064R.getCachePath(view.getContext(), "screenshot"), String.valueOf(System.currentTimeMillis()) + ".jpg");
