...
public class Arrays {
    ...
    private static class ArrayList<E> extends AbstractList<E> implements Serializable, List<E>, RandomAccess {
        ...
        public boolean contains(Object obj) {
            if (obj != null) {
                for (Object equals : this.f6249a) {
                    if (obj.equals(equals)) {
                        return true;
                    }
                }
            } else {
                for (Object equals2 : this.f6249a) {
                    if (equals2 == null) {
                        return true;
                    }
                }
        ...
        public int indexOf(Object obj) {
            int i = 0;
            if (obj != null) {
                while (i < this.f6249a.length) {
                    if (obj.equals(this.f6249a[i])) {
                        return i;
                    }
                    i++;
                }
        ...
        public int lastIndexOf(Object obj) {
            int length;
            if (obj != null) {
                for (length = this.f6249a.length - 1; length >= 0; length--) {
                    if (obj.equals(this.f6249a[length])) {
                        return length;
                    }
                }
            } else {
                for (length = this.f6249a.length - 1; length >= 0; length--) {
                    if (this.f6249a[length] == null) {
                        return length;
                    }
                }
            }
        ...
        public Object[] toArray() {
            return (Object[]) this.f6249a.clone();
        }
        ...
        public <T> T[] toArray(T[] tArr) {
            ...
            System.arraycopy(this.f6249a, 0, obj, 0, size);
            if (size < obj.length) {
                obj[size] = null;
            }
            return obj;
