...
public class LruMemoryCache<K, V> {
    ...
    L_0x0043:
        ...
        goto L_0x0000;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yf.gattlib.http.afinal.bitmap.core.LruMemoryCache.trimToSize(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        synchronized (this) {
            ...
            format = String.format("LruMemoryCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i)});
        }
        return format;
    }
}
