...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    class ProGuard extends TypeAdapter<T> {
        ...
        ProGuard(boolean z, boolean z2, Gson gson, TypeToken typeToken) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        if (excludeClass || excludeClass2) {
            return new ProGuard(excludeClass2, excludeClass, gson, typeToken);
        }
        return null;
    }
