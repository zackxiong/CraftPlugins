...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    class ProGuard extends BoundField {
        ...
        ProGuard(String str, boolean z, boolean z2, Gson gson, Field field, TypeToken typeToken, boolean z3) {
    ...
    private BoundField createBoundField(Gson gson, Field field, String str, TypeToken<?> typeToken, boolean z, boolean z2) {
        return new ProGuard(str, z, z2, gson, field, typeToken, Primitives.isPrimitive(typeToken.getRawType()));
    }
