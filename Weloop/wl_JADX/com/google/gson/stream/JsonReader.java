...
public class JsonReader implements Closeable {
    ...
    final class ProGuard extends JsonReaderInternalAccess {
        ProGuard() {
        }
    ...
    static {
        NON_EXECUTE_PREFIX = ")]}'\n".toCharArray();
        JsonReaderInternalAccess.INSTANCE = new ProGuard();
    }
    ...
    private int doPeek() {
        ...
        if (i == PEEKED_BEGIN_OBJECT) {
            ...
            switch (nextNonWhitespace(true)) {
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_listDividerAlertDialog /*44*/:
                    break;
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_popupMenuStyle /*59*/:
                    checkLenient();
                    break;
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_buttonBarPositiveButtonStyle /*93*/:
            ...
            switch (nextNonWhitespace(true)) {
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_toolbarNavigationButtonStyle /*58*/:
                    break;
        ...
        switch (nextNonWhitespace(true)) {
            ...
            case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_popupMenuStyle /*59*/:
                break;
            case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_alertDialogTheme /*91*/:
    ...
    private int peekNumber() {
        ...
        while (true) {
            ...
            int i7;
            switch (c) {
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_dialogPreferredPadding /*43*/:
                    if (i4 != PEEKED_TRUE) {
                        return PEEKED_NONE;
                    }
                    i = PEEKED_FALSE;
                ...
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_dropdownListPreferredItemHeight /*46*/:
                    ...
                    obj2 = obj;
                    continue;
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_listPreferredItemHeightLarge /*69*/:
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_editTextStyle /*101*/:
    ...
    private boolean isLiteral(char c) {
        switch (c) {
            ...
            case '}':
                break;
            case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_actionModeSelectAllDrawable /*35*/:
            case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_spinnerDropDownItemStyle /*47*/:
            case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_popupMenuStyle /*59*/:
            case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_editTextColor /*61*/:
            case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_textColorAlertDialogListItem /*92*/:
                checkLenient();
                break;
            default:
                return true;
        ...
        while (true) {
            ...
            if (c == '\n') {
                ...
                switch (cArr[this.pos]) {
                    case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_dialogTheme /*42*/:
                        this.pos += PEEKED_BEGIN_OBJECT;
                        if (skipTo("*/")) {
        ...
        if (this.pos != this.limit || fillBuffer(PEEKED_BEGIN_OBJECT)) {
            ...
            switch (c) {
                case PEEKED_UNQUOTED /*10*/:
                    ...
                    this.lineStart = this.pos;
                    return c;
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_buttonStyleSmall /*98*/:
                    return '\b';
                case uk.co.chrisjenx.calligraphy.ProGuard.styleable.Theme_radioButtonStyle /*102*/:
                    return '\f';
