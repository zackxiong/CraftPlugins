...
public class ProGuard {
    private static final Object f47f;
    private static ProGuard f48g;
    private final Context f49a;
    private final HashMap<BroadcastReceiver, ArrayList<IntentFilter>> f50b;
    private final HashMap<String, ArrayList<ProGuard>> f51c;
    private final ArrayList<ProGuard> f52d;
    private final Handler f53e;

    /* renamed from: android.support.v4.a.d.a */
    private static class ProGuard {
        final Intent f42a;
        final ArrayList<ProGuard> f43b;

        ProGuard(Intent intent, ArrayList<ProGuard> arrayList) {
            this.f42a = intent;
            this.f43b = arrayList;
        }
    }
    ...
    private static class ProGuard {
        final IntentFilter f44a;
        final BroadcastReceiver f45b;
        boolean f46c;

        ProGuard(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f44a = intentFilter;
            this.f45b = broadcastReceiver;
        }

        public String toString() {
            StringBuilder stringBuilder = new StringBuilder(com.umeng.update.util.ProGuard.f5670c);
            stringBuilder.append("Receiver{");
            stringBuilder.append(this.f45b);
            stringBuilder.append(" filter=");
            stringBuilder.append(this.f44a);
    ...
    public static ProGuard m99a(Context context) {
        ProGuard proGuard;
        synchronized (f47f) {
            if (f48g == null) {
                f48g = new ProGuard(context.getApplicationContext());
            }
            proGuard = f48g;
        }
        return proGuard;
    ...
    private ProGuard(Context context) {
        ...
        this.f49a = context;
        this.f53e = new ProGuard(this, context.getMainLooper());
    }

    public void m103a(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f50b) {
            ProGuard proGuard = new ProGuard(intentFilter, broadcastReceiver);
            ArrayList arrayList = (ArrayList) this.f50b.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList(1);
                this.f50b.put(broadcastReceiver, arrayList);
            }
            arrayList.add(intentFilter);
            for (int i = 0; i < intentFilter.countActions(); i++) {
                String action = intentFilter.getAction(i);
                arrayList = (ArrayList) this.f51c.get(action);
                if (arrayList == null) {
                    arrayList = new ArrayList(1);
                    this.f51c.put(action, arrayList);
                }
    ...
    public void m102a(BroadcastReceiver broadcastReceiver) {
        synchronized (this.f50b) {
            ArrayList arrayList = (ArrayList) this.f50b.remove(broadcastReceiver);
            if (arrayList == null) {
                return;
            }
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                for (int i2 = 0; i2 < intentFilter.countActions(); i2++) {
                    ...
                    ArrayList arrayList2 = (ArrayList) this.f51c.get(action);
                    if (arrayList2 != null) {
                        int i3 = 0;
                        while (i3 < arrayList2.size()) {
                            int i4;
                            if (((ProGuard) arrayList2.get(i3)).f45b == broadcastReceiver) {
    ...
    public boolean m104a(android.content.Intent r17) {
        /*
        r16 = this;
        r0 = r16;
        r13 = r0.f50b;
    ...
    L_0x0092:
        ...
        r0 = r1;
        r0 = (android.support.v4.p008a.ProGuard.ProGuard) r0;	 Catch:{ all -> 0x0103 }
        r9 = r0;
    ...
    L_0x009c:
        ...
        r14 = r9.f44a;	 Catch:{ all -> 0x0103 }
        r7 = r7.append(r14);	 Catch:{ all -> 0x0103 }
        r7 = r7.toString();	 Catch:{ all -> 0x0103 }
        android.util.Log.v(r1, r7);	 Catch:{ all -> 0x0103 }
    L_0x00b6:
        r1 = r9.f46c;	 Catch:{ all -> 0x0103 }
    ...
    L_0x013d:
        ...
        r1 = (android.support.v4.p008a.ProGuard.ProGuard) r1;	 Catch:{ all -> 0x0103 }
        r3 = 0;
        r1.f46c = r3;	 Catch:{ all -> 0x0103 }
        r1 = r2 + 1;
        r2 = r1;
        goto L_0x0137;
    L_0x014a:
        r0 = r16;
        r1 = r0.f52d;	 Catch:{ all -> 0x0103 }
        r2 = new android.support.v4.a.d$a;	 Catch:{ all -> 0x0103 }
        r0 = r17;
        r2.<init>(r0, r10);	 Catch:{ all -> 0x0103 }
        r1.add(r2);	 Catch:{ all -> 0x0103 }
        r0 = r16;
        r1 = r0.f53e;	 Catch:{ all -> 0x0103 }
        r2 = 1;
    ...
    L_0x0171:
        ...
        goto L_0x00fc;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.a.d.a(android.content.Intent):boolean");
    }
    ...
    L_0x000c:
        ...
        return;
    L_0x000e:
        r4 = new android.support.v4.p008a.ProGuard.ProGuard[r0];	 Catch:{ all -> 0x003f }
        r0 = r8.f52d;	 Catch:{ all -> 0x003f }
    ...
    L_0x002a:
        r0 = r5.f43b;
        r0 = r0.get(r1);
        r0 = (android.support.v4.p008a.ProGuard.ProGuard) r0;
        r0 = r0.f45b;
        r6 = r8.f49a;
        r7 = r5.f42a;
        r0.onReceive(r6, r7);
    ...
    L_0x0042:
        ...
        goto L_0x001c;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.a.d.a():void");
    }
}
