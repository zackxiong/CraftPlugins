...
public class Pinyin4jAppletDemo extends JApplet {
    ...
    final class C07341 extends WindowAdapter {
        private final Pinyin4jAppletDemo val$appletDemo;

        C07341(Pinyin4jAppletDemo pinyin4jAppletDemo) {
    ...
    final class C07352 implements ActionListener {
        private final Pinyin4jAppletDemo this$0;

        C07352(Pinyin4jAppletDemo pinyin4jAppletDemo) {
    ...
    final class C07363 implements ActionListener {
        private final Pinyin4jAppletDemo this$0;

        C07363(Pinyin4jAppletDemo pinyin4jAppletDemo) {
            this.this$0 = pinyin4jAppletDemo;
        }
    ...
    public Pinyin4jAppletDemo() {
        ...
        this.formattedCharPanel = null;
        this.optionPanel = null;
        this.convertButton = null;
        this.buttonPanel = null;
        this.formattedOutputField = null;
        this.toneTypesComboBox = null;
        this.vCharTypesComboBox = null;
        this.caseTypesComboBox = null;
        this.caseTypes = new String[]{"LOWERCASE", "UPPERCASE"};
        this.vCharTypes = new String[]{"WITH_U_AND_COLON", "WITH_V", "WITH_U_UNICODE"};
        this.toneTypes = new String[]{"WITH_TONE_NUMBER", "WITHOUT_TONE", "WITH_TONE_MARK"};
        this.toneLabel = null;
        this.charLabel = null;
        this.charTextField = null;
        this.unformattedCharPanel = null;
        this.unformattedHanyuPinyinLabel = null;
        this.unformattedHanyuPinyinTextArea = null;
        this.unformattedHanyuPinyinPanel = null;
        this.unformattedTongyongPinyinPanel = null;
        this.unformattedTongyongPinyinLabel = null;
        this.unformattedTongyongPinyinTextArea = null;
        this.unformattedWadePinyinPanel = null;
        this.unformattedWadePinyinLabel = null;
        this.unformattedWadePinyinTextArea = null;
        this.unformattedMPS2PinyinPanel = null;
        this.unformattedMPS2PinyinLabel = null;
        this.unformattedMPS2PinyinTextArea = null;
        this.unformattedYalePinyinPanel = null;
        this.unformattedYalePinyinLabel = null;
        this.unformattedYalePinyinTextArea = null;
        this.unformattedGwoyeuRomatzyhPanel = null;
        this.unformattedGwoyeuRomatzyhLabel = null;
        this.unformattedGwoyeuRomatzyhTextArea = null;
        this.unformattedMPS2PinyinScrollPane = null;
        this.unformattedHanyuPinyinScrollPane = null;
        this.unformattedTongyongPinyinScrollPane = null;
        this.unformattedWadePinyinScrollPane = null;
        this.unformattedYalePinyinScrollPane = null;
        this.unformattedGwoyeuRomatzyhScrollPane = null;
        init();
    }
    ...
    private JButton getConvertButton() {
        if (this.convertButton == null) {
            ...
            this.convertButton.addActionListener(new C07352(this));
        }
    ...
    private JComboBox getToneTypesComboBox() {
        if (this.toneTypesComboBox == null) {
            ...
            this.toneTypesComboBox.addActionListener(new C07363(this));
        }
    ...
    public static void main(String[] strArr) {
        ...
        jFrame.addWindowListener(new C07341(pinyin4jAppletDemo));
